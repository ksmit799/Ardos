...
enum MessageTypes : uint16_t {
  ...
  CLIENTAGENT_MUTEX_ACQUIRE = 1015,
  CLIENTAGENT_MUTEX_RELEASE = 1016,
  ...
  STATESERVER_OBJECT_GET_CLASS = 2016,
  STATESERVER_OBJECT_GET_CLASS_RESP = 2017,
...
enum ClientDisconnects : uint16_t {
  ...
  CLIENT_DISCONNECT_MUTEX_VIOLATION = 154,
};
